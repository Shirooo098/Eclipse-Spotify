...
public class Payment_Credit499 extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    Payment_Credit499 frame = new Payment_Credit499();
  ...
  mainPanel.add(btnNewButton);
                 ...
                 JLabel lblNewLabel_2 = new JLabel("P499/month");
